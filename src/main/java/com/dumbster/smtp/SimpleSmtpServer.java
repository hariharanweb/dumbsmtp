...
import com.hari.mail.dump.IMailListener;
...
public class SimpleSmtpServer implements Runnable {
    ...
    private final ArrayList<IMailListener> mailListeners;
    ...
    public SimpleSmtpServer(int port) {
        ...
        this.port = port;
        mailListeners = new ArrayList<IMailListener>();
    }
    ...
    private List handleTransaction(PrintWriter out, BufferedReader input) throws IOException {
        ...
        for (IMailListener listener : mailListeners) {
            listener.mail(msgList);
        }
    ...
    public void addListener(IMailListener mailListener) {
